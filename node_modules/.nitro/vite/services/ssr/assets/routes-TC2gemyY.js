import { c as BRAND, l as PRACTICES, n as breadcrumbSchema } from "./seo-jqMf855H.js";
import { t as services } from "./services-DXKwhnB2.js";
import { t as StructuredData } from "./structured-data-Cl9uiAtF.js";
import { n as team } from "./team-TTw5Yq0x.js";
import { t as Reveal } from "./reveal-DgNVJpJO.js";
import { t as Portrait } from "./portrait-DnXtzqbI.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, ArrowUpRight, Award, Globe, Shield, Users } from "lucide-react";
		...
		children: [
						...
						children: [
							...
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Start a conversation", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-1" })]
								}), /* @__PURE__ */ jsxs(Link, {
									to: "/services",
									...
									children: ["See what we do", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" })]
								})]
							}),
							/* @__PURE__ */ jsx(motion.div, {
								...
								children: trustIndicators.map((item) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: Array.from({ length: 2 }).map((_, r) => /* @__PURE__ */ jsx("div", {
						className: "flex gap-8 sm:gap-16",
						children: PRACTICES.map((t) => /* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("p", { children: [BRAND.name, " was founded on a simple premise. That the best technology work comes from small teams of senior people who own outcomes end to end, and who stay long enough to see their decisions through."] }) }),
							/* @__PURE__ */ jsx(Reveal, {
								delay: .1,
								children: /* @__PURE__ */ jsx("p", { children: "We partner with founders, functional leaders, and enterprise teams on the systems that carry real weight. Our engagements tend to be measured in quarters, not weeks, and we structure them so that our clients emerge with capability, not just deliverables." })
							}),
							/* @__PURE__ */ jsx(Reveal, {
								delay: .2,
								children: /* @__PURE__ */ jsxs(Link, {
									...
									children: ["Read our story", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})
							})
						]
					})]
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						children: ["All services ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
					})]
				}), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: "Explore"
								}), /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-5 w-5 text-muted-foreground transition-transform group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-primary" })]
							})]
						})
					}, s.slug))
				})]
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							...
							className: "mt-4 sm:mt-6 font-display fluid-h2",
							children: ["Chosen for the work that ", /* @__PURE__ */ jsx("span", {
								className: "italic",
						...
						children: strengths.map((s, i) => /* @__PURE__ */ jsx(Reveal, {
							delay: i * .08,
							children: /* @__PURE__ */ jsxs("div", {
								className: "bg-background p-6 sm:p-8 h-full",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "flex items-start gap-3",
									children: [/* @__PURE__ */ jsx("span", { className: "mt-2 h-2 w-2 rounded-full bg-primary shrink-0" }), /* @__PURE__ */ jsx("h3", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						to: "/team",
						className: "inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition touch-target",
						children: ["Meet the team ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
					})]
				}), /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 pointer-events-none bg-gradient-to-t from-background/80 via-transparent to-transparent" })]
								}),
								/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 sm:-right-32 sm:-top-32 h-48 w-48 sm:h-96 sm:w-96 rounded-full bg-primary/20 blur-3xl" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -bottom-12 -left-12 sm:-bottom-24 sm:-left-24 h-36 w-36 sm:h-72 sm:w-72 rounded-full bg-accent/10 blur-3xl" }),
						/* @__PURE__ */ jsxs("div", {
							className: "relative",
							children: [
								/* @__PURE__ */ jsx("p", {
								...
								/* @__PURE__ */ jsxs("h2", {
									...
									children: ["Have a problem worth ", /* @__PURE__ */ jsx("span", {
										className: "italic",
								...
								/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Start a conversation ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})
							]
						})
					]
