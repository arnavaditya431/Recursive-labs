...
import { Send, Sparkles, Terminal, Trash2, User, X } from "lucide-react";
	...
	return text.split(/(```[\s\S]*?```)/g).map((part, index) => {
			...
			return /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Terminal, { className: "h-3.5 w-3.5 text-primary" }), lang || "Code"]
					})
				}), /* @__PURE__ */ jsx("pre", {
		...
		return /* @__PURE__ */ jsx("div", {
			...
			children: part.split("\n").map((line, lIdx) => {
				...
				if (isBullet) return /* @__PURE__ */ jsx("li", {
...
function Chatbot({ onClose }) {
	...
	return /* @__PURE__ */ jsxs(motion.div, {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "absolute -left-16 -top-16 pointer-events-none h-48 w-48 rounded-full bg-primary/20 blur-3xl" }),
			/* @__PURE__ */ jsxs("div", {
				...
				children: messages.length === 0 ? /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: SUGGESTED_PROMPTS.map((p) => /* @__PURE__ */ jsx("button", {
					...
					className: "space-y-6",
					children: [
						messages.map((m, idx) => /* @__PURE__ */ jsxs("div", {
