import { c as BRAND, n as breadcrumbSchema } from "./seo-jqMf855H.js";
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [timeline.map((t, i) => /* @__PURE__ */ jsx(Reveal, {
							delay: i * .06,
							children: /* @__PURE__ */ jsxs("div", {
						...
						}, t.year)), /* @__PURE__ */ jsx("div", { className: "border-t hairline" })]
					})
				]
			})
		})
