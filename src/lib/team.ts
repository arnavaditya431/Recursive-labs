/** Local assets for professional portraits */
const TEAM_PHOTOS = {
  siddhi: "/team/siddhi.jpg",
  pragalbh: "/team/pragalbh.jpg",
  arnav: "/team/arnav.jpg",
  aditya: "/team/aditya.jpg",
  sanskriti: "/team/sanskriti.jpg",
} as const;
...
export const team: TeamMember[] = [
  {
    ...
    photo: TEAM_PHOTOS.siddhi,
    focus: "Strategy",
    mission:
      "Translating engineering depth into commercial clarity for the organisations we serve.",
    specializationBg:
    ...
    education: [
      { school: "Dronacharya Group of Institutions", detail: "Business & Strategy", year: "2022" },
    ],
    expertise: ["Go-to-market strategy", "Client advisory", "Digital transformation", "Partner ecosystems"],
    skills: ["Consultative selling", "Account strategy", "Executive communication", "Market research", "Commercial modelling"],
    projects: [
      { name: "Enterprise Retail Modernisation", summary: "Led the discovery and commercial framing for a multi-quarter modernisation programme across storefront and back-office systems." },
    ...
    socials: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/siddhi-sharma-4bb4a2383" }, { label: "Email", href: "mailto:siddhisharma3x@gmail.com" }],
  },
  {
    slug: "pragalbh-aditya",
    name: "Pragalbh Aditya",
    role: "Co-Founder",
    title: "Chief Operating Officer",
    photo: TEAM_PHOTOS.pragalbh,
    focus: "Operations",
    mission:
      "Building the operating rhythm that lets a boutique firm deliver with enterprise discipline.",
    specializationBg:
    ...
    education: [
      { school: "Nalanda College of Engineering", detail: "Operations & Management", year: "2023" },
    ],
    ...
    socials: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/pragalbh-aditya" }, { label: "Email", href: "mailto:pragalbhaditya@gmail.com" }],
  },
  {
    slug: "arnav-aditya",
    name: "Arnav Aditya",
    role: "Founding Analyst",
    title: "AI & Business Analyst",
    photo: TEAM_PHOTOS.arnav,
    focus: "Artificial Intelligence",
    mission:
      "Pairing applied research with the discipline of shipping software enterprises can operate.",
    specializationBg:
    ...
    education: [
      { school: "Manipal University Jaipur", detail: "Computer Science, AI specialisation", year: "2026" },
    ],
    expertise: ["Applied AI", "Retrieval and RAG systems", "Product engineering", "Evaluation frameworks"],
    skills: ["Python", "TypeScript", "LLM orchestration", "Vector databases", "Systems design", "Prompt engineering"],
    projects: [
      { name: "Enterprise Knowledge Copilot", summary: "Architected a retrieval-grounded assistant across a client's internal document estate with strict access controls." },
    ...
    socials: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/arnav-aditya-974217361" }, { label: "Email", href: "mailto:arnavaditya@gmail.com" }],
  },
  {
    slug: "aditya-kumar",
    name: "Aditya Kumar",
    ...
    title: "CTO",
    photo: TEAM_PHOTOS.aditya,
    focus: "Engineering",
    mission:
      "Owning the technical spine from cloud architecture to the interface craft clients feel every day.",
    specializationBg:
    ...
    education: [
      { school: "SRM Institute of Science and Technology (SRM KTR)", detail: "Computer Science & Engineering", year: "2023" },
    ],
    expertise: ["Cloud architecture", "Distributed systems", "Full-stack engineering", "DevOps and platform"],
    skills: ["TypeScript", "Go", "AWS", "Kubernetes", "PostgreSQL", "React", "Node.js", "Terraform"],
    projects: [
      { name: "Multi-tenant SaaS Platform", summary: "Designed and shipped the core platform architecture powering a B2B SaaS across three regions." },
    ...
    socials: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/aditya-kumar-aba257381" }, { label: "Email", href: "mailto:kumaraditya9926@gmail.com" }],
  },
  {
    slug: "sanskriti-roy",
    name: "Sanskriti Roy",
    ...
    photo: TEAM_PHOTOS.sanskriti,
    focus: "Design",
    mission:
      "Championing clarity, restraint, and the details that separate software people tolerate from software they trust.",
    specializationBg:
    ...
    education: [
      { school: "Silicone University", detail: "Interaction Design", year: "2023" },
    ],
    expertise: ["Product strategy", "UX research", "Design systems", "Service design"],
    skills: ["Figma", "Design systems", "Prototyping", "User interviews", "Information architecture", "Motion design"],
    projects: [
      { name: "Enterprise Design System", summary: "Established a tokenised design system adopted across four product lines and multiple engineering teams." },
    ...
    email: "",
    socials: [{ label: "LinkedIn", href: "https://www.linkedin.com/in/sanskriti-roy-947117385" }],
  },
];
